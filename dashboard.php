  ...
  <div class="row content">
    <div class="col-sm-3 sidenav hidden-xs">
      ...
      <ul class="nav nav-pills nav-stacked">
        <li><a class="active" href="dashboard.php">-HOME</a></li><br><br>
        <li><a href="donoralerts.php">-DONOR ALERTS</a></li><br><br>
        <li><a href="analysis.php">-ANALYSIS MODE</a></li><br><br>
    ...
    <div class="col-sm-9" style="background-color: #d60505;">
      ...
      <p class="img1" align="left">Types Of Donations</p>
      <p class="img2" align="right">Blood Types</p>
      <center>
        <img src="images/graph.png" align="left" style="width: 40%;height: 40%;">
        
      <img src="images/pie.jpg" align="right" style="width: 40%;height: 40%;">
      </center>
