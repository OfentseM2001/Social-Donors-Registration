  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a class="active" href="analysis.php">Analysis Mode</a></li>
  ...
  <div class="row content">
    <div class="col-sm-3 sidenav hidden-xs">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li><a class="active" href="analysis.php">-ANALYSIS MODE ></a></li><br>
    ...
    <img src="images/graph1.png" align="left" style="width: 40%;height: 40%;">
    <img src="images/graph3.jpg" align="right" style="width: 40%;height: 40%;">
