...
<br><br>
<div class="card mb-8" style="max-width: 1500px;height:100%;">
    <div class="row g-0">
      ...
      <div class="col-md-8">
        ...
        <div class="card-body">
          ...
          <center>
            <p class="card-text1">
                Welcome To The Social Donors Admin Dashboard
                </p>
         ...
         <!-- <button class="button button1"></button> -->
          <br><br>
         <button type="button" class="btn btn-danger" align="right"><a href="adminlogin.php">Click Here To Login</a></button>
